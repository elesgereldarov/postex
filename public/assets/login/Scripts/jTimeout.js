(function ($) {
    ...
    $.jTimeout.defaults = {
        ...
        'flashingTitleText': '**Uyarı**', //what to show in the tab/title bar when about to timeout, or after timing out
        ...
        'timeoutAfter': 1200,// 1440, //pass this from server side to be fully-dynamic. For PHP: ini_get('session.gc_maxlifetime'); - 1440 is generally the default timeout
        ...
        'extendUrl': '/Home/RefreshSession', //URL to request in order to extend the session.
        'logoutUrl': '/Account/LogoutSession', //URL to request in order to force a logout after the timeout. This way you can end a session early based on a shorter timeout OR if the front-end timeout doesn't sync with the backend one perfectly, you don't look like an idiot.
        'loginUrl': '/Account/LogoutSession', //URL to send a customer when they want to log back in
        ...
        'onPriorCallback': function(timeout, seconds){
            $.jAlert({
                ...
                'content': '<b>Bir süredir işlem yapmadınız. Devam etmek istiyor musunuz ?<br/> Kalan Süre :<span class="jTimeout_Countdown">' + seconds + '</span></b>',
                'theme': 'default',
                'size': 'md',
                'closeBtn': false,
        ...
        'onTimeout': function(timeout){
            ...
            $.jAlert({
                'id': 'jTimedoutAlert',
                'title': 'Uyarı!',
                'content': '<b>Oturum süreniz dolmuştur.</b>',
                'theme': 'default',
                'size': 'md',
                'btns': {
                    'text': 'Giriş',
