...
(function(n, t) {
    ...
    function tt(t, i) {
        ...
        function ht(n) {
            ...
            ft = new RegExp(e(n[0]) + "\\s*");
            v = new RegExp("\\s*" + e(n[1]));
            st = new RegExp("\\s*" + e("}" + n[1]))
        }
        ht(i || n.tags);
        for (var f = new r(t), c, o, s, b, et, l; !f.eos();) {
            if (c = f.pos, s = f.scanUntil(ft), s)
                for (var ot = 0, lt = s.length; ot < lt; ++ot) b = s.charAt(ot), p(b) ? y.push(a.length) : w = !0, a.push(["text", b, c, c + 1]), c += 1, b === "\n" && ct();
            if (!f.scan(ft)) break;
            if (ut = !0, o = f.scan(nt) || "name", f.scan(k), o === "=" ? (s = f.scanUntil(h), f.scan(h), f.scanUntil(v)) : o === "{" ? (s = f.scanUntil(st), f.scan(g), f.scanUntil(v), o = "&") : s = f.scanUntil(v), !f.scan(v)) throw new Error("Unclosed tag at " + f.pos);
            if (et = [o, s, c, f.pos], a.push(et), o === "#" || o === "^") tt.push(et);
            else if (o === "/") {
                if (l = tt.pop(), !l) throw new Error('Unopened section "' + s + '" at ' + c);
                if (l[1] !== s) throw new Error('Unclosed section "' + l[1] + '" at ' + c);
            } else o === "name" || o === "{" || o === "&" ? w = !0 : o === "=" && ht(s)
        }
        if (l = tt.pop(), l) throw new Error('Unclosed section "' + l[1] + '" at ' + f.pos);
        return rt(it(a))
    }
    ...
    i.prototype.lookup = function(n) {
        ...
        if (e.hasOwnProperty(n)) t = e[n];
            ...
            for (var i = this, r, u, o = !1; i;) {
                if (n.indexOf(".") > 0)
                    for (t = i.view, r = n.split("."), u = 0; t != null && u < r.length;) u === r.length - 1 && (o = s(t, r[u])), t = t[r[u++]];
                else t = i.view[n], o = s(i.view, n);
                if (o) break;
                i = i.parent
            }
            e[n] = t
    ...
    t.prototype.renderSection = function(n, t, i, r) {
        ...
        function c(n) {
            return h.render(n, t, i)
        }
        if (e) {
            if (u(e))
                for (var s = 0, l = e.length; s < l; ++s) o += this.renderTokens(n[4], t.push(e[s]), i, r);
    ...
    return n.clearCache = function() {
        ...
        return o.render(n, t, i)
    }, n.to_html = function(t, i, r, u) {
        var e = n.render(t, i, r);
        if (f(u)) u(e);
        else return e
    }, n.escape = b, n.Scanner = r, n.Context = i, n.Writer = t, n
});;
