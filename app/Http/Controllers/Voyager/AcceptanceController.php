...
class AcceptanceController extends VoyagerBaseController
{
    //***************************************
    //               ____
    //              |  _ \
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            //if ($search->value != '' && $search->key && $search->filter) {
                ...
                if ($row = $this->findSearchableRelationshipRow($dataType->rows->where('type', 'relationship'), $search->key)) {
                    ...
                    if($fin != ''){
                        $query = $query->where('sender_fin', '=', $fin);
                    }
                    if($status != ''){
    ...
    public function teslim(Request $request)
    {
        // GET THE SLUG, ex. 'posts', 'pages', etc.
        $slug = 'acceptances'; //$this->getSlug($request);
        ...
        if (view()->exists("voyager::$slug.ready")) {
            $view = "voyager::$slug.ready";
        }
